...
// document.writeln("Сегодня " + Day + " " + Month + " " + Year + " года, " + 
// Hour + getNoun(Hour, " час ", " часа ", " часов ") + Minutes + getNoun(Minutes, " минута ", " минуты ", " минут ") + 
// Seconds + getNoun(Seconds, " секунда ", " секунды ", " секунд ") + "<br/>");
...
// document.writeln(getZero(Day) + '.' + getZero(date.getMonth() + 1) + '.' + getZero(Year) + 
